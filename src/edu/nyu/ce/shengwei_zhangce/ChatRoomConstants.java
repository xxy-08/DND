...
public class ChatRoomConstants {
	public static final String IP_ADDR_1 = "224.0.0.1"; // please revise here if communication is not successful
	 ...
	 public static final int PORT_1 = 6666; // please revise here if communication is not successful
	 public static final int PORT_2 = 8888; // please revise here if communication is not successful

	public static final int WORD_SIZE = 18;
	public static final int USER_WINDOW_SIZE = 15;
